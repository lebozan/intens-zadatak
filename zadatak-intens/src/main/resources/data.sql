...
insert into skills(skill_name) values ('ReactJS');
...
insert into skills(skill_name) values ('German language');
...
insert into job_candidates_skills(job_candidate_id, skills_id) values (1, 8);
...
insert into job_candidates_skills(job_candidate_id, skills_id) values (2, 8);
